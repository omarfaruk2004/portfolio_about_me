                ...
                f || ((d = "data-rel"), (f = c(this).attr(d))),
                  ...
                  h.each(function () {
                    ...
                    c(this).attr("title") && (a = c(this).attr("title")),
                      ...
                      c(this).attr("link-github") &&
                        (x = c(this).attr("link-github")),
                      c(this).attr("link-site") &&
                        (y = c(this).attr("link-site")),
        ...
        setTitle: function (a) {
          ...
          b
            ? (c("#swipebox-top-bar").show(),
              c("#swipebox-title").append(
                `<a id="swipebox-github" href="${
                  k[a].github
                }" target="_blank">${" "}</a>`
              ),
              c("#swipebox-title").append(b),
              c("#swipebox-title").append(
                `<a id="swipebox-site" href="${
                  k[a].site
                }" target="_blank">${" "}</a>`
              ))
